...
The main observable of this lab is the frequency of rotation $f$ of the motor, which  is proportional to the torque applied to the motor. Similar to the first capacitance lab, you are also asked to find possible parameters that could affect the frequency of rotation of the motor.
