...
\textbf{ {\color{blue} we expect you to either answer a question or to write down some discussion associated with text that has a blue font.}} \underline{Take note of this if you intend to print the manual using} \underline{black/white ink.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{appendix-utility-box-inside}
