...
\noindent In session a, you will conclude how well your experimental data support (or not) the hypotheses you set out to prove. Also included here can be a brief discussion on other physical properties that can be studied, or offering a better methodology to study this phenomenon in session b.
...
Each category above will be assessed according to a 4-level performance rubric: unsatisfactory, minimally satisfactory, and exceeding expectations (bonus points). The weight of the lab mark assigned to each rubric may vary from one lab to the other.
